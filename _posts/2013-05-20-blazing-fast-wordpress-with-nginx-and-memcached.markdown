...
<pre>TTFB            0.244 seconds
Response Time   310 ms
Hit Rate        89 hits/second</pre>

{% responsive_image path: assets/nginx-wpsc.png alt: "Nginx + WPSC" %}

### Nginx + PHP-FPM + Memcached

<pre>TTFB            0.126 seconds
Response Time   241 ms
Hit Rate        94 hits/second</pre>

{% responsive_image path: assets/nginx-memcached.png alt: "Nginx + PHP-FPM + Memcached" %}
